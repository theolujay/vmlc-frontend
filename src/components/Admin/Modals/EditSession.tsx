...
export default function EditSessionModal({ open, close }: Readonly<{ open: boolean, close: (close: boolean) => void }>) {
                ...
                <form action="" className="flex flex-col gap-4">
                    <div className="flex flex-col">
                     ...
                     <div className="flex flex-col">
                        ...
                        <textarea required className='border outline-0 p-2 resize-none border-[#D0D5DD] rounded-lg' name="" id=""/>
                    </div>
