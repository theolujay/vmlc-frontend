...
// export default function EmailVerificationModal({ open, close, }: Readonly<{ open: boolean, close: (close: boolean) => void }>) {
//     const { timer } = useEmailCountdown()
...
//         close(!open)
//     }
//     const { onSubmit, form, isPending, resendOtpFunction, resendPending } = useVerifyEmailForCandidates()
