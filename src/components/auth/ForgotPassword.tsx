                        ...
                        <Tabs.Root value={tab} onValueChange={(v) => setTab(v as TabType)} className="w-full">
                            <Tabs.Content value='forgot' className="outline-none animate-in fade-in slide-in-from-right-4 duration-300">
                                <div className="flex flex-col items-center text-center">
                                    <div className="w-14 h-14 bg-[#3E4095]/5 rounded-2xl flex items-center justify-center text-[#3E4095] mb-3">
                                        <i className="fas fa-key text-xl"></i>
                                    </div>
                                    <h2 className='text-xl font-black text-gray-800 tracking-tight uppercase'>Forgot Password?</h2>
                                    <p className="text-[10px] text-gray-500 font-medium mt-1 leading-relaxed max-w-[80%]">Please enter your email and we&apos;ll send an OTP to reset it</p>
                                </div>
                            </Tabs.Content>
                            ...
                            <Tabs.Content value='reset' className="outline-none animate-in fade-in slide-in-from-right-4 duration-300">
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h2 className='text-xl font-black text-gray-800 tracking-tight uppercase'>Check Your Mail</h2>
                            ...
                            <Tabs.Content value='newPassword' className="outline-none animate-in fade-in slide-in-from-right-4 duration-300">
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h2 className='text-xl font-black text-gray-800 tracking-tight uppercase'>Set New Password</h2>
                                    <p className="text-[10px] text-gray-500 font-medium mt-1 leading-relaxed">Your new password must be different from previous ones.</p>
                                </div>
                            </Tabs.Content>

                            <Tabs.Content value='done' className="outline-none animate-in fade-in slide-in-from-right-4 duration-300">
                                <div className="flex flex-col items-center text-center">
                                    <div className="w-14 h-14 bg-green-50 rounded-2xl flex items-center justify-center text-green-600 mb-3">
                                        <i className="fas fa-check-circle text-xl"></i>
                                    </div>
                                    <h2 className='text-xl font-black text-gray-800 tracking-tight uppercase'>All Done!</h2>
                                    <p className="text-[10px] text-gray-500 font-medium mt-1 leading-relaxed">Your password has been successfully reset. You can now login.</p>
                                </div>
                            </Tabs.Content>
                        </Tabs.Root>
                    </div>
                                    ...
                                    <form onSubmit={sendEmailForm.handleSubmit(async (data) => {
                                        ...
                                        <div className="flex flex-col gap-3">
                                            <button
                                                type="submit"
                                                disabled={isPending}
                                                className="w-full px-6 py-4 rounded-2xl font-black text-[10px] tracking-[0.2em] uppercase text-white bg-[#3E4095] shadow-xl shadow-[#3E4095]/20 hover:-translate-y-1 transition-all flex items-center justify-center gap-3 disabled:opacity-70 disabled:translate-y-0"
                                            >
                                    ...
                                    <form onSubmit={otpForm.handleSubmit(async (data) => {
                                        ...
                                        <div className="flex flex-col gap-3">
                                            <button
                                                type="submit"
                                                disabled={otpPending}
                                                className="w-full px-6 py-4 rounded-2xl font-black text-[10px] tracking-[0.2em] uppercase text-white bg-[#3E4095] shadow-xl shadow-[#3E4095]/20 hover:-translate-y-1 transition-all flex items-center justify-center gap-3"
                                            >
                            ...
                            <Tabs.Content value='done' className="outline-none">
                                <div className="flex flex-col gap-5">
                                    <div className="p-5 bg-green-50/50 rounded-2xl border border-green-100/50">
                                        <p className="text-xs text-green-800 font-medium leading-relaxed text-center italic">
