...
// export default function CaptureDialog({ open, close, onCaptureFile,isPending }: { open: boolean, close: (close: boolean) => void, onCaptureFile: (file: File) => void ,isPending:boolean}) {
...
//       const file = dataURLtoFile(imageSrc, "profile_photo.jpg")
//       onCaptureFile(file)
...
//               RECAPTURE
//             </button>
//             <button onClick={} disabled={isPending} className={clsx("px-4 cursor-pointer py-2 rounded-lg flex-1 bg-[#3E4095] text-white")}>
          ...
          <div className="flex capture flex-col">
            ...
            <div className="flex gap-2 mt-4 w-full">
              <button
                ...
                className="px-4 py-2 font-bold cursor-pointer rounded-lg border border-gray-300 text-gray-700"
              >
                RECAPTURE
              </button>
              <button
                ...
                disabled={isPending}
                className={clsx(
                  "px-4 cursor-pointer py-2 rounded-lg flex-1 bg-[#3E4095] text-white",
                  isPending && "opacity-70 cursor-not-allowed bg-[#98A2B3]"
                )}
              >
                {isPending ? <Spinner /> : 'UPLOAD'}
              </button>
          ...
          <div className="flex capture flex-col">
            ...
            <div className="flex gap-2 mt-4 w-full">
              ...
              <button
                ...
                disabled={!isAligned}
                className={clsx(
                  "px-4 uppercase font-bold cursor-pointer py-2 rounded-lg flex-1 text-white",
                  isAligned ? 'bg-[#3E4095] hover:bg-[#2d2f6e]' : 'bg-[#98A2B3]'
                )}
              >
                Capture
              </button>
