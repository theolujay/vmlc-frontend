    ...
    return (
        <div className="flex flex-col gap-1 w-full">
            ...
            <div className="flex gap-3 w-full">
                ...
                {Array.from({ length: 6 }).map((_, index) => <div key={`otpfield-${index}`} className={clsx('flex border-2 w-1/6  bg-white focus:outline-1 focus:outline-amber-300 gap-1 items-center px-2 rounded-[8px]', className)}>
