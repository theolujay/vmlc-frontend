		...
		<DropdownMenu.Root>
			...
			<DropdownMenu.Portal>
				<DropdownMenu.Content
					...
					sideOffset={5}
				>
                    <DropdownMenu.Item className="group relative flex  h-[25px]  items-center   leading-none  outline-none  ">
						<div className=" pr-5  ">
							<ProfileIcon/>
						</div>
						View Profile{" "}
					...
					<DropdownMenu.Item className="group relative flex text-[#D42620] h-[25px]  items-center   leading-none  outline-none  ">
						<div className=" pr-5  ">
							<LogOutIcon/>
						</div>
						Log out{" "}
